...
import type { TaskServiceConfig } from '~/domains/task/infra/task.service'
    ...
    describe('task', () => {
      describe('infra', () => {
        describe('task service', () => {
          ...
          beforeAll(async () => {
            vi.doMock(
              '~/domains/task/infra/firestore/firestore-task.service',
              () => ({
            ...
            getTaskService = (await import('~/domains/task/infra/task.service'))
              .getTaskService
          })
